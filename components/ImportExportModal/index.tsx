...
interface ImportExportModalProps {
  isVisible: boolean;
  onDismiss: () => void;
  onImportData: (replaceData: boolean, events: T.Event[]) => Promise<boolean>;
...
> {
  ...
  onLearnMore = async () => {
    Linking.openURL('https://loggit.net/import-export-file-format');
  };
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            const success = await onImportData(false, events);
        ...
        },
        {
          ...
          onPress: async () => {
            this.setState({ isSubmitting: true });
            const success = await onImportData(true, events);
            this.setState({ isSubmitting: false });
            if (success) {
              onDismiss();
            }
    ...
    return (
      ...
      >
        ...
        <Text style={styles.note}>
          Import a JSON file exported from Loggit before.
        </Text>
